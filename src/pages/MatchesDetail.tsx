...
const MatchesDetail = () => {
  ...
  const matches: Record<number, Match> = {
    1: {
      ...
      events: {
        ...
        2: [
          ...
          { time: "23:16", type: "penalty", player: "Hruška T.", reason: "Nedovolená hra vysokou hokejkou" },
    ...
    2: {
      ...
      events: {
        1: [
          { time: "7:00", type: "goal", team: "away", player: "Kozár P.", assists: ["Ščasný M."] },
          { time: "11:00", type: "penalty", player: "Tatar J.", reason: "Podrazenie" },
        ],
        2: [
          { time: "19:00", type: "penalty", player: "Sabo M.", reason: "Nedovolené bránenie" },
          { time: "20:00", type: "goal", team: "home", player: "Tatar J.", assists: ["Tvrdoň M."] },
          { time: "23:00", type: "goal", team: "away", player: "Solčiansky P.", assists: ["Kozár P."] },
        ],
        3: [
          { time: "25:00", type: "goal", team: "away", player: "Slovák P.", assists: ["Galo J."] },
          { time: "26:00", type: "goal", team: "home", player: "Tvrdoň M.", assists: ["Slovák M."] },
          { time: "27:00", type: "penalty", player: "Tvrdoň M.", reason: "Napadnutie" },
          { time: "34:00", type: "goal", team: "away", player: "Magáth Š.", assists: ["Ščasný M."] },
          { time: "36:00", type: "goal", team: "away", player: "Galo J.", assists: [] },
        ],
      },
      periodScores: { 1: "0-1", 2: "1-1", 3: "1-3" },
      formations: {
        1: {
          goalkeeper: { number: 30, name: "Teplan", photo: "/players/teplan.png" },
          defender: { number: 11, name: "Bibeň", photo: "/players/player.png" },
          forwards: [
            { number: 90, name: "Tatar", photo: "/players/tatar.png" },
            { number: 12, name: "Parák", photo: "/players/player.png" },
          ],
